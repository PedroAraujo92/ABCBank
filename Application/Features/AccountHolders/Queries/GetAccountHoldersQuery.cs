...
public class GetAccountHoldersQueryHandler(IUnitOfWork<int> unitOfWork)
    : IRequestHandler<GetAccountHoldersQuery, ResponseWrapper<List<AccountHolderResponse>>>
{
